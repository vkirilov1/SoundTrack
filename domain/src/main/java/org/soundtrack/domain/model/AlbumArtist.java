...
/**
 * Join entity linking an {@link Album} to an {@link Artist}, carrying the artist's credit order for
 * that album (0 = primary artist, matching MusicBrainz's artist-credit ordering). Rows imported
